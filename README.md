...
| [NAVIA](https://github.com/m1lestones/navia-app) | 1mo ago | 0 | `JavaScript` `Node.js` `AI` |
...
| [PlateIQ](https://github.com/PlateIQ-Team/Plate-IQ) | 3mo ago | 0 | `React` `Node.js` `PostgreSQL` `AI` |
...
| [XRP Insights Dashboard](https://github.com/m1lestones/xrp-insights-dashboard) | 10mo ago | 0 | `Python` `XRPL` |
